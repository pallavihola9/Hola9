...
class Product(models.Model):
    ...
    uuid=models.CharField(max_length=123123,null=True)
    phoneNumberCollectVisiters=models.CharField(max_length=123123,null=True)
    date_expire = models.CharField(max_length=150,null=False,blank=False ,default="null")
...
class BusinessProfile(models.Model):
    ...
    aadhar_card = models.ImageField(upload_to='', blank=False, null=False)
    pan_card = models.ImageField(upload_to='', blank=False, null=False)
