...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('adsapi', '0055_alter_adsmangeme_date_created_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='date_created',
            field=models.CharField(default='2023-07-12', max_length=20),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='pricing',
            name='ads_timing',
            field=models.CharField(default='2023-07-12', max_length=30),
        ),
        migrations.AlterField(
